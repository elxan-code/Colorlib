        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Title3 = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TitleQuestion = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Answer = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuesAccordions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BlogCategorid = table.Column<int>(type: "int", nullable: false),
                    Tagid = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TagtoBlocks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TagtoBlocks_BlogCategories_BlogCategorid",
                        column: x => x.BlogCategorid,
                        principalTable: "BlogCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TagtoBlocks_Tags_Tagid",
                        column: x => x.Tagid,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Blogs_BlogCategories_BlogCategorid",
                        column: x => x.BlogCategorid,
                        principalTable: "BlogCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Popularposts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Popularposts_Blogs_Blogid",
                        column: x => x.Blogid,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Blogs_BlogCategorid",
                table: "Blogs",
                column: "BlogCategorid");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Popularposts_Blogid",
                table: "Popularposts",
                column: "Blogid");

            migrationBuilder.CreateIndex(
                name: "IX_Socials_Blogid",
                table: "Socials",
                column: "Blogid");

            migrationBuilder.CreateIndex(
                name: "IX_TagtoBlocks_BlogCategorid",
                table: "TagtoBlocks",
                column: "BlogCategorid");

            migrationBuilder.CreateIndex(
                name: "IX_TagtoBlocks_Tagid",
                table: "TagtoBlocks",
                column: "Tagid");
        }
